...
\subsection{Event Selection}\label{sec:selection}
  ...
  \subsubsection{Optical Pre-selection}\label{sec:optpresel}
    ...
    94~$\mu s$ wide. Then the total number of PE of any optical pulses that
  ...
  \subsubsection{NC Elastic Pre-selection}
    ...
    \begin{table}
      ...
      \begin{tabularx}{\textwidth}{l r r r}
        ...
        Containment & 0.57 & 0.92 & 0.005 \\
        Length & 0.49 & 0.87 & 0.005 \\
        Proton Score & 0.41 & 0.83 & 0.009 \\
        \hline
      \end{tabularx}
    \end{table}
    \begin{figure}[ht]
  ...
  \subsubsection{Selection Variables}
    ...
    direction of the neutrino beam. The following seven variables are used to select these events,
    \begin{enumerate}
    ...
    Figs.~\ref{fig:lrpid}-\ref{fig:lrpiflash}.
