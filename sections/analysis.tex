...
\subsection{Comparison of data to simulation}
  ...
  \subsubsection{Event reweighting}
    ...
    The NC elastic weight that we calculate. How it's the cross sections. What
    do we do? Show plots.

    GENIE systematic weights and multiplying them.

    Summing the event weights to get new data comparison.
