...
\subsection{Electroweak Scattering Matrix Elements}
  ...
  \subsubsection{Vector current}
    ...
    \begin{equation}
      \begin{aligned}
        _{\textrm{p(n)}}\mel{p'}{J^{\mu}_{em}}{p}_{\textrm{p(n)}} 
            &= _{\textrm{p(n)}}\mel{p'}{V^{\mu}_3 + V^{\mu}_0)}{p}_{\textrm{p(n)}} \\
            &= _{\textrm{p(n)}}\mel{p'}{V^{\mu}_3}{p}_{\textrm{p(n)}} 
             + _{\textrm{p(n)}}\mel{p'}{V^{\mu}_0}{p}_{\textrm{p(n)}} \,,
      \end{aligned}
    \end{equation}
    ...
    \begin{equation}
      \begin{aligned}
        _{\textrm{p}}\mel{p'}{V^{\mu}_3}{p}_{\textrm{p}} 
          &= - _{\textrm{n}}\mel{p'}{V^{\mu}_3}{p}_{\textrm{n}} \,, \\
        _{\textrm{p}}\mel{p'}{V^{\mu}_0}{p}_{\textrm{p}} 
          &= + _{\textrm{n}}\mel{p'}{V^{\mu}_0}{p}_{\textrm{n}} \,. \\
      \end{aligned}
    \end{equation}
    Then
    \begin{align}\label{eq:V3em}
      _{\textrm{p}}\mel{p'}{V^{\mu}_3}{p}_{\textrm{p}} 
        &= \frac{1}{2} \left[_{\textrm{p}}\mel{p'}{J^{\mu}_{em}}{p}_{\textrm{p}} 
         - _{\textrm{n}}\mel{p'}{J^{\mu}_{em}}{p}_{\textrm{n}} \right] \,, \\
      _{\textrm{p}}\mel{p'}{V^{\mu}_0}{p}_{\textrm{p}} 
        &= \frac{1}{2} \left[_{\textrm{p}}\mel{p'}{J^{\mu}_{em}}{p}_{\textrm{p}} 
         + _{\textrm{n}}\mel{p'}{J^{\mu}_{em}}{p}_{\textrm{n}} \right] \,.
    \end{align}
  ...
  \subsubsection{Axial current}
    ...
    \begin{equation}
      _{\textrm{p}}\mel{p'}{A^{\mu}_+}{p}_{\textrm{n}} 
      = _{\textrm{n}}\mel{p'}{A^{\mu}_-}{p}_{\textrm{p}} 
      \equiv _{\textrm{p}}\mel{p}{A^{\mu}_+}{p'}_{\textrm{n}}^* \,,
    \end{equation}
    ...
    is similarly
    \begin{equation}
      _{\textrm{p}}\mel{p'}{A^{\mu}_3}{p}_{\textrm{n}} 
    ...
    \begin{equation}
      _{\textrm{p}}\mel{p'}{A^{\mu}_3}{p}_{\textrm{p}}
       = \frac{1}{2}_{\textrm{p}}\mel{p'}{A^{\mu}_+}{p}_{\textrm{n}}\,,
    \end{equation}
    which implies
    \begin{equation}
...
\subsection{Strangeness in the nucleon} \label{sec:strangeness}
  ...
  \begin{equation}
     _{\textrm{p}}\mel{p'}{J^{\mu}_{CC}}{p}_{\textrm{n}} 
       = _{\textrm{p}}\mel{p'}{V^{\mu}_3}{p}_{\textrm{n}}
       - _{\textrm{p}}\mel{p'}{A^{\mu}_3}{p}_{\textrm{n}} \,.
  \end{equation}
  ...
  \begin{equation}
    \begin{aligned}
      _{\textrm{p}}\mel{p'}{J^{\mu}_{NC}}{p}_{\textrm{p}} 
       = (1-2\sin^2\theta_w)&(_{\textrm{p}}\mel{p'}{V^{\mu}_3}{p}_{\textrm{p}}
        - _{\textrm{p}}\mel{p}{\frac{1}{2}V^{\mu}_s}{p}_{\textrm{p}}) \\
       - &(_{\textrm{p}}\mel{p'}{A^{\mu}_3}{p}_{\textrm{p}}
        - _{\textrm{p}}\mel{p}{\frac{1}{2}A^{\mu}_s}{p}_{\textrm{p}}) \\
       - 2\sin^2\theta_W&(_{\textrm{p}}\mel{p'}{V^{\mu}_0}{p}_{\textrm{p}}
        - _{\textrm{p}}\mel{p}{\frac{1}{2}V^{\mu}_{0s}}{p}_{\textrm{p}}) \,.
    \end{aligned}
  \end{equation}
...
\subsection{Determination of the Nucleon Form Factors} \label{sec:formfactorforms}
  ...
  See~\cite{Perdrisat2008}~and~\cite{EMformfactors} for an extensive review of
  the nucleon electromagnetic form factors.
  
  The most common parameterization of the axial form factor, the dipole form,
  has only one free parameter known as the axial mass,
  $M_A$~\cite{axialformfactor},
  \begin{equation}
  ...
  Sum rules [92.013013], asymptotic freedom [Lepage Brodsky], choice of $t_0$ [93.113015].
  ...
  are fit simultaneously up to $k_{max} = 12$ using a previous unpolarized
  electron-proton scattering data and $G_E^p/G_m^p$ ratios extracted from
  polarized electron-proton data. The neutron electric and magnetic form
  factors, $G_E^n(Q^2)$ and $G_M^n(Q^2)$, are fit separately to up $k_{max} =
  10$ using polarized and unpolarized electron-deuterium and electron-helium-3
  scattering data.
  ...
  8$ using accelerator neutrino-deuterium data from deuterium bubble chamber
  experiments. They found results similar to a dipole form but with larger,
