...
Outline the MicroBooNE section.
...
\subsection{The Booster Neutrino Beam and the MicroBooNE detector}\label{sec:beam}
  ...
  \subsubsection{Dirt interactions}
...
\subsection{Simulation and Reconstruction}\label{sec:simreco}
  ...
  \subsubsection{Cross section model and event generation}
    ...
    Need to add: cross section and nuclear model
    ...
    generate these interactions. To simulate real detector events as closely as
    possible, both neutrino and cosmic ray interactions can be generated in the
    same simulation. They can also be generated in separate events in order to
    isolate effects.
