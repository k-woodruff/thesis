...
\subsection{The Booster Neutrino Beam}\label{sec:beam}
  ...
  %%% NOTE %%%
  Add information about the hadron production cross sections; pions, kaons,
  muons and their decay modes, neutrino rates and energies. Also mention about
  stopping muons vs. muons decaying in motion.
  %%%%%%%%%%%%
  ...
  $1\times 10^6$ protons on the target (POT).
...
\subsection{MicroBooNE light collection system and event trigger}\label{sec:swtrigger}
  ...
  are produced per MeV of deposited energy ~\cite{detectorpaper}. The
  scintillation photons have a wavelength of 128 nm and do not re-interact with
  the argon.  The light collection system in MicroBooNE consists of 32
